...
hidden if the `redirect-to-os-log_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `redirect-to-os-log_DEVELOPER_MODE` to the configure
